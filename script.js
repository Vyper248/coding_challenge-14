...
const submitScore = () => {
    ...
    fetch('https://match-game-challenge.onrender.com/leaderboard', {
        method: 'POST',
...
const getScores = () => {
    fetch('https://match-game-challenge.onrender.com/leaderboard/'+leaderboardDifficulty).then(resp => resp.json()).then(data => {
